    ...
    public partial class userProfile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE member_master_tbl SET full_name=@full_name , dob=@dob,contact_num=@contact_num,email=@email,state=@state,city=@city,pincode=@pincode,full_address=@full_address,password=@password,account_status=@account_status  where member_id='" + Session["username"].ToString().Trim() + "'", con);
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                if (dt.Rows[0]["account_status"].ToString().Trim() == "active")
                    ...
                    Label1.Attributes.Add("class", "badge rounded-pill bg-secondary");
